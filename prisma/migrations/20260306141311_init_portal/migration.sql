...
-- CreateIndex
CREATE UNIQUE INDEX "Appointment_calBookingUid_key" ON "Appointment"("calBookingUid");
...
-- AddForeignKey
ALTER TABLE "TriageResponse" ADD CONSTRAINT "TriageResponse_appointmentId_fkey" FOREIGN KEY ("appointmentId") REFERENCES "Appointment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
