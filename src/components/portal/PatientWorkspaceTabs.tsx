    ...
    <div className="flex flex-col h-full w-full bg-workspace">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1 overflow-hidden">
        ...
        <div className="flex-1 overflow-hidden relative">
           ...
           <TabsContent value="evaluacion" forceMount className="h-full m-0 p-10 overflow-y-auto !custom-scrollbar outline-none data-[state=inactive]:hidden">
             <div className="text-slate-500 font-medium">Contenido de Evaluación y Diagnóstico: Síntomas y Doshas (Placeholder)</div>
           </TabsContent>
